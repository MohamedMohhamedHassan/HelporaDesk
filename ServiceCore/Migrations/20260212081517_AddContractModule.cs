...
namespace ServiceCore.Migrations
{
    ...
    public partial class AddContractModule : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Contracts_Users_AssignedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractAttachments_Users_UploadedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractHistories_Users_ChangedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractAttachments_UploadedById",
                table: "ContractAttachments",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_ContractHistories_ChangedById",
